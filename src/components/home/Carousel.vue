    ...
    data: function () {
      return {
        items: [{
          ...
          img: 'https://i.loli.net/2020/10/26/VCbkDWoPBunMdE5.png',
          link: 'http://how2j.cn?p=50613'},
        {
          id: 2,
          title: 'Vue.js - 渐进式 JavaScript 框架',
          // img: '../../../static/img/carousel/vue.png',
          img: 'https://i.loli.net/2020/10/26/kLCjP41fYMxISAX.png',
        ...
        },
        {
          ...
          img: 'https://i.loli.net/2020/10/26/An7zJWjweO1Xc5d.png',
